...
function createWindow() {
	...
	mainWindow.ipcMain.on('openDialog', () => {
		dialog
	...
	ipcMain.on('PersistenciaCarpeta', () => {
	...
	ipcMain.on('busca', (_evento, ruta) => {
		...
		let arraybuffer = file.buffer.slice(file.byteOffset, file.byteOffset + file.byteLength);
